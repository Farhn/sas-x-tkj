      ...
      {currentPage === 'home' && (
        <div className="h-screen flex flex-col items-center justify-center bg-gray-200 text-black">
          <div className='gap-y-2 mb-6'>
            ...
            <a href="https://drive.google.com/drive/folders/1rPk9t59BmoPQJP4A_laKPHPwvVheMPRi?usp=sharing" className='text-sm font-medium text-green-800 hover:text-teal-400 text-center'>asset gambar+catatan</a>
          </div>
